...
public class ArrayTest1 {
	...
	public static void main(String[] args) {
		...
		// 배열의 생성 : 변수들의 저장 공간 생성
		// new 자료형[개수] : 개수만큼의 연속된 변수를 생성하고 묶음으로 만든다.
		arr = new int[3];
		
		// 배열의 참조 : 입력, 읽기
		// 배열이름[index] : 배열의 변수는 순차적으로 위치하기 때문에 index값으로 참조
		// index : 0 ~ 요소의 개수-1
		// 배열이름.length 인스턴스 변수 : 요소의 개수 저장
		
		arr[0] = 1;
		arr[1] = 2;
		arr[2] = 3;
		
		System.out.println("배열 arr 요수 개수 : " + arr.length);
		...
		// 생성과 동시에 배열 요소 초기화
		int[] arr2 = {1,2,3,4,5};
		System.out.println("배열 arr2 요소 개수 : " + arr2.length);
		...
		// 로또 번호 추출 프로그램
		// 정수 데이터 1~45 숫자를 저장하는 변수 45개 생성 -> int 타입 배열 선언, 생성
		int[] ball = new int[45];
		
		// 각 변수에 1~45 숫자를 중복되지 않게 저장
	...
	*/	
		// 각 index 값들을 섞는 처리 : index=0 의 값과 임의의(1~44) index 값을 서로 바꾼다.
