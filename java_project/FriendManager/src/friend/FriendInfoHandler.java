...
public class FriendInfoHandler {
	...
	private int numOfFriends;	// 저장된 친구 정보 개수, 배열 요소 추가시 index로 사용
	...
	// 배열에 친구 정보를 저장하는 기능 : 다형성 이용한 매개변수 정의
	...
	void addFriend(int choice) {
		...
		// 사용자로부터 기본 정보를 입력받자 : 이름, 전하ㅗ번호, 주소
	...
	public void showAllData() {
		...
		for(int i=0; i<numOfFriends; i++) {
			friends[i].showData();	// friends[0] -> Frined 타입의 참조변수 = 하위클래스의 인스턴스들을 참조
			System.out.println("-----");
		}
	}
