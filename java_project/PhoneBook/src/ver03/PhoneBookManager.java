...
public class PhoneBookManager {
	...
	int cnt;	// 저장된 정보 개수 : 반복의 횟수 사용, 배열에 새로운 데이터 입력시 index로 사용
	...
	// 사용자로부터 데이터를 받아서 ->
	// 인스턴스 생성 ->
	// 배열에 생성된 인스턴스의 참조값을 저장 : index는 cnt를 이용, 저장 후에는 cnt++
	void insertMember() {
...
//		// 검색 : index를 찾는다.
//		for(int i=0; i<cnt; i++) {
//			if(phoneBook[i].name.contentEquals(name)) {
//				index = i;
//				break;
//			}
//		}
...
//			}
			...
			if(index < 0) {
				...
				// 삭제처리 : 삭제해야하는 index부터 왼쪽으로 시프트처리
				// index = 3;
