...
-- 1. 덧셈연산자를 이용하여 모든 사원에 대해서 $300의 급여 인상을 계산한 수 사원의 이름, 급여, 인상된 급여를 출력하시오.
...
-- 5. 급여가 2000에서 3000 사이에 포함되지 않는 사원의 -> 범위 : betwoon 또는 논리연산
--      이름과 급여를 출력하시오.
select ename, sal
from emp
...
--      '81/01/01' -> 81로 시작하고 뒤에 오는 문자열은 0 이상의 문자열이 올 수 있는 조건
--      like '81%'
...
--      null : 있는 것도 아니고 없는것도 아닌 데이터 연산의 결과도 null -> 비교연산불가, 산술연산 불가
--      is null / is not null
select ename, job
from emp
where mgr is null
